    ...
    return <div>
      <MDBRow>
        <MDBCol>
          ...
          <h5 className='p-1 mdb-color w-100 font-weight-bold cartTitle mt-3'>Cart<MDBIcon className='float-right pr-3 mt-1 mdb-color' size='md' icon="shopping-cart" /></h5>
          
          
          {listProducts} 
          <h5 className='mdb-color w-100 cartTitle mt-1 mb-0 pt-1 mb-1 p-2 total'><span className=''>Total:</span>
          <span className='float-right'>{formatPrice(sum)}</span></h5>
          </div>
        </MDBCol>
